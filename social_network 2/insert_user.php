...
include("includes/connection.php");
    if(isset($_POST['sign_up'])){
        $irst_name = htmlentities(mysqli_real_escape_string($con,$_POST['first_name']));
        ...
        user_pass, user_mail,user_country,user_gender, user_birthday,user_image, user_cover, user_reg_date, status, posts,
        recovery_account)
        values('$first_name','$last_name','$username', 'Hello Public Pantry. This is my
            default status!','...','$pass','$email','$country','$gender','$birthday',
            '$profile_pic','default_cover.jpg', NOW(),'$status','$posts','Iwanttoputading
            intheuniverse.')";
