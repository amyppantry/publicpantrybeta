...
<html>
<head>
	<title>thepublicpantry Login and Signup</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="row">
		<div class="col-sm-6" style="left: 0.5%;">
			<img src="images/thepublicpantry.jpeg" class="img-rounded" title="thepublicpantry" width="650px" height="565px">
		...
		<div class="col-sm-6" style="left: 8%;">
			<img src="images/thepublicpantrylogo.jpeg" class="img-rounded" title="thepublicpantry" width="80px" height="80px">
			<h2><strong>See what's happening in <br> the world right now.</strong></h2><br><br>
			<h4><strong>Join thepublicpantry Today.</strong></h4>
