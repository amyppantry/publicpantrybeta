...
$con = mysqli_connect("localhost","root","","socialnetwork_db") or die("Connection
not established");
...
function get_posts(){
    ...
    function single_post(){
        if(isset($_GET['post_id'])){
            ...
            $run_com = mysqli_query($con, $get_come);
                ...
                <div class='col-sm-6'>
                    <div class='row' id='find_people'>
                        <div class='col-sm-4'>
                            ...
                            <img src='users/$user_image' width='150px' height='140px' title='$username' style='float:left; ,marging:1px;'/>
                            </a>
                        </div><br><br>
                        <div class='col-sm-6'>
