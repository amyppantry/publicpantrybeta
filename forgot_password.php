...
<div class="row">
    <div class="col-sm-12">
        <div class="well">
            <center><h1 style="color: white;"><strong>The Public Pantry </strong>></h1></center>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="l_pass">
                <form class="" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Someone" name="recover_account" required>
                    </div><br>
                    <a stype="text-decoration: none;float: right;color: #187FAB;" data-toggle="tooltip" title="Signin" href="Signin.php">Back to Signin?</a><br><br>
...
include("includes/connection.php");
    ...
    if(isset($_POST['submit'])){
        ...
        $recover_account = htmlentities(mysqli_real_escape_string($con, $_POST['recovery_account']));

        $select_user = "select * from users where user_email='$email' AND
        recovery_account='$recover_account'";
